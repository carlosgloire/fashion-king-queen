...
if (isset($_POST['add'])) {
    ...
    $folder = "./background_images/" . $filename;
    ...
    if (empty($filename)) {
        ...
        $existing_product_query = $db->prepare("SELECT * FROM background_images WHERE photo=:photo  ");
        ...
        if ($existing_product) {
            ...
            $query = $db->prepare('INSERT INTO background_images (photo) VALUES (:photo)');
