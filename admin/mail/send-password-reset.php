...
if(isset($_POST['send'])){
 ...
 if(isset($_POST['email'])){
    ...
    if(empty($_POST['email'])){
        $error ="Veillez ecrire le mail ";
     }
    elseif(!$mail_query){
        $error ="Nous n'avons trouvé aucun compte avec cette adresse e-mail. Veuillez réessayer ";
    }else{
        ...
        if ($mysqli->affected_rows) {
            ...
            <body>
                <div class="container">
                    ...
                    <p style="text-align: center;"><a class="button" href="http://localhost/fashion-style/admin/mail/reset-password.php?token=$token">Reset Password</a></p>
